...
if ( ! class_exists( 'WC_Iran_Pishtaz_Shipping' ) ) {
	class WC_Shipping_Iran_Pishtaz extends WC_Shipping_Method {
		...
		public function __construct() {
			...
			$this->method_description = __( '<h3>روش پست پیشتاز ایران برای ووکامرس</h3>
		...
		public function calculate_shipping( $package = array() ) {
			...
			$rate_price['9999']['in'] 		= 21000;
			$rate_price['9999']['out'] 		= 21000;
			...
			if ( $weight_indicator != '9999' ) { // is less than 2000 gram
				...
				$shipping_total = $rate_price['2000'][$checked_state] +
									( $rate_price[$weight_indicator][$checked_state] * ceil ( ( $tmp_weight - 2000) / 1000 ) );
			}
