...
final class WC_Shipping_Certified extends \WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->id = 'iran_shipping_certified';
		// Title shown in admin
		$this->method_title = esc_html__( 'Certified Post', 'woocommerce-iran-post-shipping' );
		...
		$this->method_description = __(
			...
			<p style="text-align: justify">
				...
				<ol>
					<li>Make sure to enter the weight for each product, and the acceptable weight units in the WooCommerce settings are grams and kilograms.</li>
					<li>Other rates, including packet cost, box cost, packaging, stamp, fragile items cost, additional rates from the sender\'s location, off-hours acceptance rate, electronic tracking inquiry, electronic ID, and other optional items, are not included in this calculation and are entirely optional. (Post offices are obligated to add these rates only upon the sender\'s request).</li>
					...
					<li>It\'s advisable to set the "Default Customer Location" option in the global WooCommerce settings.</li>
					<li>This plugin is coded in accordance with WooCommerce coding standards; province values are created based on WooCommerce principles. However, other plugins, including "WooCommerce Persian," may make changes to this list that could affect the functionality of this plugin. If you encounter any issues, deactivate parallel plugins with this one and test again. Additionally, WooCommerce, like WordPress, is already translated into Persian and does not require a Persian translator.</li>
				</ol>
			</p>',
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'              => array(
				...
				'default'     => esc_html__( 'Certified Post', 'woocommerce-iran-post-shipping' ),
				'desc_tip'    => true,
			),
			'extra_cost'         => array(
			...
			'disable_for_higher' => array(
				...
				'type'        => 'text',
				'description' => esc_html__( 'The certified shipping accepts orders up to 5 kilograms. You can specify this amount here', 'woocommerce-iran-post-shipping' ),
				'default'     => '5000',
				'desc_tip'    => true,
			),
			'source_state'       => array(
